...
public class MysqlDAOFactoryBY{ /**  Наследование от DAOFactory, так как класс родитель может служить набором БД, к которым можно подключиться, но в нашем случае только MySQL
...
public static String DB_NAME = "byy"; /** Название БД, если она не создана, либо названа неправильно ПРОГРАММА РАБОТАТЬ НЕ БУДЕТ */
