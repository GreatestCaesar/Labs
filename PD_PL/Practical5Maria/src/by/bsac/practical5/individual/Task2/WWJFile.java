...
public class WWJFile {
    public static void main(String[] args){
        ...
        String filePath = "E:\\PD&PL\\Practical5\\src\\by\\bsac\\practical5\\individual\\Task2\\";                      // путь к любому(желательно нигде не задействованному) java файлу, можно копировать в папку проекта любой другой файл для безопасности и указать путь
