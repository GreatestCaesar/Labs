...
public class RandomFile {
    public static void main(String[] args){
        ...
        String filePath = "src/by/bsac/practical5/individual/task2/RandomNumbers/";  // путь к папке, в которой будет создаваться файл
                                                                                                                        // всё до \\Practical5 заменить на своё расположение проекта
