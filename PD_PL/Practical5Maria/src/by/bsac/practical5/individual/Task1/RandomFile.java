...
public class RandomFile {
    public static void main(String[] args){
        ...
        String filePath = "E:\\PD&PL\\Practical5Maria\\src\\by\\bsac\\practical5\\individual\\Task1\\RandomNumbers\\";  // путь к папке, в которой будет создаваться файл
                                                                                                                        // всё до \\Practical5Maria заменить на своё расположение проекта
