...
public class Create {
    ...
    private static final String DROP = "drop database if exists derivativ;";
    private static final String CREATE_DATABASE = "create database derivativ";
    private static final String CREATE_TABLE_PRESENT = "create table derivativ(amountOfRisk int,cost int,degree double)";
