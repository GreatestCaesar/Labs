...
public class WWJFile {
    public static void main(String[] args){
        ...
        String filePath = "src/by/bsac/practical5/individual/task3/";                      // путь к любому(желательно нигде не задействованному) java файлу, можно копировать в папку проекта любой другой файл для безопасности и указать путь
